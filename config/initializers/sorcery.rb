...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.twitter.key = 'jvjyBU9sVgG4AhS6b7UH1FnCg'
  config.twitter.secret = 'Kx8Letzxfd8CUeBHR6KV9aUENW53Fas8FBLXUPMCTt3K1gwpTo'
  config.twitter.callback_url = "http://localhost:3000/oauth/callback?provider=twitter"
  config.twitter.user_info_mapping = {:email => "screen_name"}
  #
  config.facebook.key = "1500506076667566"
  config.facebook.secret = "49b773ea0c79f4a6676c866ad2edcc2d"
